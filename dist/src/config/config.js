...
//Cars
exports.container
    .bind(export_1.SERVICE_IDENTIFIER.CarsValidator)
    .to(export_3.CarsValidator);
exports.container.bind(export_1.SERVICE_IDENTIFIER.ICarsService).to(export_5.CarsService);
exports.container.bind(export_1.SERVICE_IDENTIFIER.ICarsRepo).to(export_4.CarRepo);
exports.container
    .bind(export_1.SERVICE_IDENTIFIER.ICarsController)
    .to(export_2.CarsController);
// container
